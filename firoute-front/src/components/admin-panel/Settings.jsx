...
import { MdArrowRight, MdSecurity , MdHotel, MdSettings} from 'react-icons/md';
...
export default function Settings() {
    ...
    const settingsItems = [
        {
            id: 'room-management',
            title: 'Otaqların İdarəetməsi',
            description: 'Otaqları idarə edin',
            icon: <MdHotel className="w-6 h-6" />,
            bgColor: 'bg-green-100',
            iconColor: 'text-green-600',
            navigatePath: '/admin/room-management'
        },
        {
            id: 'roles-management',
            title: 'Rollar İdarəetməsi',
            description: 'İstifadəçi rollarını və icazələrini idarə edin',
        ...
        {
            id: 'radius-profiles',
            title: 'Radius Profilləri',
            description: 'Radius profillərini və qruplarını idarə edin',
            icon: <MdSettings className="w-6 h-6" />,
            bgColor: 'bg-purple-100',
            iconColor: 'text-purple-600',
            navigatePath: '/admin/radius-profiles'
        }
    ];
            ...
            {settingsItems.length === 0 && (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                    ...
                    <p className="text-gray-600">
                        Hal-hazırda heç bir tənzimləmə əlavə edilməyib.
                    </p>
                </div>
            )}
        </div>
